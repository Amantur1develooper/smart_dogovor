    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(max_length=100, region=None, unique=True, verbose_name='номер телефона')),
                ('email', models.EmailField(max_length=254, null=True, unique=True, verbose_name='электронная почта')),
                ('role', models.CharField(choices=[('individuals', 'физ-лица'), ('Legal_entities', 'Юр-лица'), ('admin', 'Администратор')], default='individuals', max_length=15, verbose_name='роль')),
